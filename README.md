...
flutter test      # юнит-тесты доменной логики (каталог test/)
```

> Юнит-тесты покрывают доменную логику приложения: алгоритм адаптивной сложности, расчёт метрик и матрицу путаницы, раздельный учёт методик диагностики (лица/истории), контрбалансировку форм A/B и хэширование ответа на контрольный вопрос. Оба шага выполняются автоматически в CI (GitHub Actions) при каждом push и pull request. Дополнительно контроль качества опирается на натурное приёмочное тестирование с участниками; подробнее о стратегии тестирования — в разделе 4.4 пояснительной записки.
...
├── test/                          # юнит-тесты доменной логики
